...
| [Green's function engine](https://colab.research.google.com/github/qumulator/qumulator-sdk/blob/main/notebooks/greens_demo.ipynb) | Free-fermion circuits, O(N²) memory, entropy map — `mode="greens"` |
...
| [LiH ground state](https://colab.research.google.com/github/qumulator/qumulator-sdk/blob/main/notebooks/lih_ground_state.ipynb) | Pauli-Hamiltonian solver — 1.15 mHa error, chemical accuracy — `client.hamiltonian` |
